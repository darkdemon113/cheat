...
{stopAngle=355;targetAngle=(360*(power*6)+ stopAngle);randomLastThreshold=Math.floor(90+(Math.random()*90));document.getElementById('spin_button').className="";$(".power_controls").hide();wheelState='spinning';doSpin();}}
